...
int main()
{
    ...
    printf("Cart contains 2 items: ");
    if(getNumItems(cart) == 2)
        printf("success.\n");
    else
        printf("FAIL.\n");

    printf("total price is $13.00: ");
    ...
    printf("no longer contains milk, but contains coffee: ");
    if(containsItem(cart, coffee) == 0)
        printf("success.\n");
    else
        printf("FAIL.\n");
    ...
    printf("cart has 1 item: ");
    if(getNumItems(cart) == 1)
        printf("success.\n");
    else
        printf("FAIL.\n");

    printf("price is $10.00: ");
    ...
    printf("cart doesn't contain avacado: ");
    if(!(containsItem(cart, avacado) > -1))
        printf("success.\n");
    else
        printf("FAIL.\n");

    printf("cart has 2 items: ");
    if(getNumItems(cart) == 2)
        printf("success.\n");
    else
        printf("FAIL.\n");

    printf("price is $13.00: ");
    if(getTotalPrice(cart) == 13)
        printf("success.\n");
    else
        printf("FAIL.\n");
