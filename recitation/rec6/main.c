...
int compareDoubles(void *value1, void *value2) {
    // FIX: Write this function
	double *dblPtr1, *dblPtr2;

	dblPtr1 = (double *)value1;
	dblPtr1 = (double *)value2;

    return (*dblPtr1 - *dblPtr2);
}

// This function will compare two strings
int compareStrings(void *value1, void *value2) {
    // FIX: Write this function. Hint: comparing strings can be done using
    // the strcmp() function.
	char *stringP1, *stringP2;

	stringP1 = (char *)value1;
	stringP2 = (char *)value2;

    return strcmp(stringP1, stringP2);
}
